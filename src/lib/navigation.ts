...
export const sidebarMenus: Record<Role, { label: string; href: string; icon: typeof LayoutDashboard }[]> = {
  ADMIN: [
    ...
    { label: "Cold Customers", href: "/admin/cold-customers", icon: Snowflake },
  ...
  SUPERVISOR: [
    ...
    { label: "Cold Customers", href: "/supervisor/cold-customers", icon: Snowflake },
  ...
  MARKETER: [
    ...
    { label: "Cold Customers", href: "/marketer/cold-customers", icon: Snowflake },
    { label: "Leads", href: "/marketer/leads", icon: Target },
    { label: "Communication", href: "/marketer/communication", icon: MessageSquare },
    { label: "Suggestions", href: "/marketer/suggestions", icon: Lightbulb },
